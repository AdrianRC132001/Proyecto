<?php
    ...
    $mostrarTitulo = detallesVideojuego($conexion, $idVideojuego);
    $tituloMostrado = mysqli_fetch_assoc($mostrarTitulo);
?>
<!DOCTYPE html>
<html lang="es-ES">
	<!--Cabecera del código.-->
	...
	<body class="fondo">
        ...
        <div class="container contenedor">
            <div class="row margen">
                <div class="col-md-8">
                    <h1 class="titulo"><i>Seleccione una portada para el videojuego: <?php echo $tituloMostrado['Título'];?></i></h1>
                    <br>
                    <form id="modificarVideojuego" name="modificarVideojuego" action="ModificarImagenVideojuego.php" method="POST" enctype="multipart/form-data">
                        <center>
