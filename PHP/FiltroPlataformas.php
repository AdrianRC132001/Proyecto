                    ...
                    <div class="container">
                        <div class="row margen">
                            ...
                            <?php
                                ...
                                $id = $_GET["id"];
                                $consulta = detallesPlataforma($conexion, $id);
                                $nombre = mysqli_fetch_assoc($consulta);
                                echo "<h1 class='titulo'><i>Videojuegos de la saga disponibles para la plataforma: " . $nombre['Nombre'] . "</i></h1>";
                                $result = filtrarPlataforma($conexion, $id);
