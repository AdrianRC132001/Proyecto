	...
	<body class="fondo">
        ...
        <div class="container contenedor">
            <div class="row margen">
                <div class="col-md-8">
                    <h1 class="titulo"><i>Nuevo mapa</i></h1>
                    <form id="mapa" name="mapa" action="NuevoMapa.php" method="POST" enctype="multipart/form-data" novalidate onsubmit="return validarFormulario();">
                        <p>
                            <?php
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" type="text" name="compania" id="compania" minlength="1" maxlength="45" placeholder="Compañía desarrolladora del mapa" required>
