<?php
    ...
    $mostrarNombre = detallesMerchandising($conexion, $idMerchandising);
	...
	<body class="fondo">
        ...
        <div class="container contenedor">
            <div class="row margen">
                <div class="col-md-8">
                    <h1 class="titulo"><i>Seleccione una imagen para el producto: <?php echo $nombreMostrado['Nombre'];?></i></h1>
                    <br>
                    <form id="modificarMerchandising" name="modificarMerchandising" action="ModificarImagenMerchandising.php" method="POST" enctype="multipart/form-data">
                        <center>
                            <input class="rojo" type="file" name="imagen" id="imagen" required>
                        </center>
                        <br>
                        <button class="btn btn-danger btn-block" type="submit" name="boton" value="Aceptar" id="boton">Aceptar</button>
                        <input type="hidden" name="idMerchandising" value="<?php echo $idMerchandising?>">
                    </form>
                    <br>
                    <center><a class="link" href="MostrarMerchandising.php">Cancelar</a></center>
                </div>
