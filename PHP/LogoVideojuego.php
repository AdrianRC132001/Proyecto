	...
	<body class="fondo">
        ...
        <div class="container contenedor">
            <div class="row margen">
                <div class="col-md-8">
                    <h1 class="titulo"><i>Seleccione un logo para el videojuego: <?php echo $tituloMostrado['Título'];?></i></h1>
                    <br>
                    <form id="modificarVideojuego" name="modificarVideojuego" action="ModificarLogoVideojuego.php" method="POST" enctype="multipart/form-data">
                        <center>
                            <input class="rojo" type="file" name="logo" id="logo" required>
                        </center>
                        <br>
