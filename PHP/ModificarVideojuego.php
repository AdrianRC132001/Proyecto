<?php
    ...
    $consulta = detallesVideojuego($conexion, $idVideojuego);
	...
	<body class="fondo">
        ...
        <div class="container contenedor">
            <div class="row margen">
                <div class="col-md-8">
                    <h1 class="titulo"><i>Datos del videojuego: <?php echo $mostrar['Título'];?></i></h1>
                    <form id="videojuego" name="videojuego" action="VideojuegoModificado.php" method="POST" enctype="multipart/form-data" novalidate onsubmit="return validarFormulario();">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label class="rojo">Título:</label>
                                <input class="form-control" type="text" name="titulo" id="titulo" minlength="1" maxlength="45" placeholder="Título del videojuego" value="<?php echo $mostrar['Título'];?>" required autofocus>
                                <span class="amarillo" id="errorTitulo">Título no válido.</span>
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" type="text" name="compania" id="compania" minlength="1" maxlength="45" placeholder="Compañía desarrolladora del videojuego" value="<?php echo $mostrar['Compañía'];?>" required>
		...
		<script src="https://use.fontawesome.com/releases/v5.15.2/js/all.js" data-auto-a11y="true"></script>
        <script src="../JavaScript/ModificarVideojuego.js"></script>
	</body>
</html>