	...
	<body class="fondo">
        ...
        <div class="container contenedor">
            <div class="row margen">
                <div class="col-md-8">
                    <h1 class="titulo"><i>Nuevo videojuego</i></h1>
                    <form id="videojuego" name="videojuego" action="NuevoVideojuego.php" method="POST" enctype="multipart/form-data" novalidate onsubmit="return validarFormulario();">
                        <p>
                            <?php
                                if(isset($_GET['error']) && $_GET['error'] == "tituloVideojuegoExiste")
                                {
                                    echo '<h4 class="error"><i class="fas fa-exclamation-triangle"></i>&nbsp;' . "El título del videojuego introducido ya existe.</h4>";
                                }
                            ?>
                        </p>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" type="text" name="titulo" id="titulo" minlength="1" maxlength="45" placeholder="Título del videojuego" required autofocus>
                            ...
                            <div class="form-group col-md-6">
                                <label class="rojo">Portada:</label>
