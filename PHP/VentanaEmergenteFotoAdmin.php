	...
	<body class="fondo">
        ...
        <div class="container contenedor">
            <div class="row margen">
                <div class="col-md-8">
                    <h1 class="titulo"><i>Seleccione una foto de perfil para el usuario: <?php echo $nickMostrado['Nick'];?></i></h1>
                    <br>
                    <form id="modificarUsuario" name="modificarUsuario" action="ModificarFotoAdmin.php" method="POST" enctype="multipart/form-data">
                        <center>
                            <input class="rojo" type="file" name="foto" id="foto" required>
                        </center>
                        <br>
