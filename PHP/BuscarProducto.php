        ...
        <div class="container contenedor">
            <div class="row margen">
                ...
                <div class="col-md-8 tab">
                    ...
                    <button class="tablinks active" onclick="panel(event, 'productos')">Productos</button>
                        ...
                        <div class="table-responsive">
                            <div class="container contenedor">
                                <div class="row margen">
                                    ...
                                    <div class="col-md-4">
                                        <a href="MostrarProductos.php" class="btn btn-warning"><i class="fas fa-table"></i>&nbsp;Mostrar todo</a>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <table class="table bg-dark rounded">
                                        ...
                                        <?php
                                            ...
                                            $result = campoBuscarProducto($conexion, $variableBusqueda);
