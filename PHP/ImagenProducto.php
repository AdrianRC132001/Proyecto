<?php
    ...
    $mostrarNombre = detallesProducto($conexion, $idProducto);
        ...
        <div class="container contenedor">
            <div class="row margen">
                <div class="col-md-8">
                    ...
                    <br>
                    <form id="modificarProducto" name="modificarProducto" action="ModificarImagenProducto.php" method="POST" enctype="multipart/form-data">
                        <center>
