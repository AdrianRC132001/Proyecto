        ...
        <div class="container contenedor">
            <div class="row margen">
                ...
                <div class="col-md-8 tab">
                    ...
                    <button class="tablinks active" onclick="panel(event, 'mapas')">Mapas</button>
                            ...
                            <div class="container contenedor">
                                <div class="row margen">
                                    <div class="col-md-4 mb-2">
                                        <a href="InsertarMapa.php" class="btn btn-warning"><i class="fas fa-plus"></i>&nbsp;Nuevo mapa</a>
                                    </div>
                                    <div class="col-md-4">
                                        <a href="MostrarMapas.php" class="btn btn-warning"><i class="fas fa-table"></i>&nbsp;Mostrar todo</a>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <table class="table bg-dark rounded">
                                        ...
                                        <?php
                                            $variableBusqueda = $_GET['busquedaMapa'];
                                            $result = campoBuscarMapa($conexion, $variableBusqueda);
