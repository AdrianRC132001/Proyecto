<?php
    ...
    $consulta = detallesMerchandising($conexion, $idMerchandising);
        ...
        <div class="container contenedor">
            <div class="row margen">
                <div class="col-md-8">
                    ...
                    <form id="merchandising" name="merchandising" action="MerchandisingModificado.php" method="POST" enctype="multipart/form-data" novalidate onsubmit="return validarFormulario();">
                        <div class="form-row">
