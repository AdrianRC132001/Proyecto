        ...
        <div class="container contenedor">
            <div class="row margen">
                <div class="col-md-8">
                    ...
                    <form id="usuario" name="usuario" action="PerfilModificado.php" method="POST" enctype="multipart/form-data" novalidate onsubmit="return validarFormulario();">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label class="rojo">Fecha de nacimiento:</label>
                                <input class="form-control" type="date" id="fechaNacimiento" name="fechaNacimiento" value="<?php echo $mostrar['FechaDeNacimiento'];?>">
